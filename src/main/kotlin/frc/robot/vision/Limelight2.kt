...
object Limelight2 {
  ...
  val targetXOffset: Quantity<Angle>?
    get() = if (hasTarget) Quantities.getQuantity(targetXOffsetEntry.getDouble(0.0), USCustomary.DEGREE_ANGLE) else null
  val targetYOffset: Quantity<Angle>?
    get() = if (hasTarget) Quantities.getQuantity(targetYOffsetEntry.getDouble(0.0), USCustomary.DEGREE_ANGLE) else null
